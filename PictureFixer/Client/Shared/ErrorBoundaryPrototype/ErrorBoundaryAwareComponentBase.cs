...
{
    // This is a temporary placeholder for the real ErrorBoundary feature.
    // The real implementation of this feature doesn't require components to inherit from a special base
    // class like this - the base class is just an aspect of the proof-of-concept implementation.

    public abstract class ErrorBoundaryAwareComponentBase : IComponent, IHandleEvent, IHandleAfterRender, IReceiveHotReloadContext
    {
